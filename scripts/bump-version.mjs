...
console.log('');
console.log('  ⚠  version.json NOT touched. Bump it manually once ' + version + ' is live on the App Store —');
console.log('     that is the file the iOS update banner compares against, so bumping it before the');
console.log('     release is available would nudge users toward a version they cannot download.');
console.log('     (This is the step that got forgotten for the last eight releases.)');
console.log('');
