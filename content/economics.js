  ...
  weeks: [
    {
      ...
      days: [
        ...
        { id: 2, title: 'הסדר שאף אחד לא תכנן', titleEn: 'The Order That No One Planned', thinker: 'אדם סמית', thinkerEn: 'Adam Smith', thinkerId: 'smith', xp: 50, sections: [
          ...
          {
            type: 'quiz',
            question: 'סמית כתב שני ספרים גדולים: תיאוריית הרגשות המוסריים (1759) על אמפתיה וחמלה, ועושר העמים (1776) על אנוכיות וכלכלה. הם נראים סותרים. מה ניתן להסיק מכך שאותו אדם כתב את שניהם?',
